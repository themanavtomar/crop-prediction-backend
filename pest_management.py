...
rainfall_threshold = 100  # Example threshold for rainfall (you can adjust it according to your needs)
humidity_threshold = 70  # Example threshold for humidity (you can adjust it according to your needs)
